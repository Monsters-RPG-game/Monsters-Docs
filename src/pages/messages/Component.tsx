  ...
  return (
    <motion.div variants={animation.opacity} initial="init" animate="visible" exit="exit" className="common-container">
      ...
      <main className="common-container_content">
        <p className="my-3">
          Messages is service which controls users messages and live-chat messages. In current state it handles
          messages, but in the future it will also manage sending items in messages alongside system messages. You can
          find it on{' '}
          <a
            href="https://github.com/Virus288/Monsters-messages"
            target="_blank"
            rel="noreferrer"
